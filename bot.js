...
bot.on('message', message =>{
    ...
    if(message.author.id != "621172703608438796" && message.channel.id === ""){
        if(msg.startsWith('>', 0)){
            if(msg === prefix + "bang" && message.channel.id === "621158677990080553"){
...
bot.login(process.env.NjIxMTcyNzAzNjA4NDM4Nzk2.XXwrSw.LjC7ETT5MKyiiQwss-v7HEsHfqs)
